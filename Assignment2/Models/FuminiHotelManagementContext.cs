...
public partial class FuminiHotelManagementContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        if (!optionsBuilder.IsConfigured) { optionsBuilder.UseSqlServer(config.GetConnectionString("FuminiHotelManagement")); }
    }

    ////#warning to protect potentially sensitive information in your connection string, you should move it out of source code. you can avoid scaffolding the connection string by using the name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. for more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?linkid=723263.
    ////        => optionsbuilder.usesqlserver("data source=laptop-0jftnre0\\sqlexpress;initial catalog=fuminihotelmanagement; trusted_connection=sspi;encrypt=false;user id=sa;password=123456;trustservercertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A14740BCF5A860").IsUnique();
